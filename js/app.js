...
function getNewQuestion(){
 	//set question number
 	questionNumber.innerHTML="Question "+(questionCounter+1)+" of 6";
...
function quizResult(){
	...
	resultBox.querySelector(".tot-question").innerHTML = 6;
	...
	const percentage =  (correctAnswers/6)*100;
	resultBox.querySelector(".tot-percentage").innerHTML = percentage.toFixed(2) + "%";
	resultBox.querySelector(".tot-score").innerHTML = correctAnswers+" /6";
}
